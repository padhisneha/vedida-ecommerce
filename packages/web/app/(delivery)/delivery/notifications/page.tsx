...
export default function DeliveryNotificationsPage() {
  ...
  const getNotificationColor = (type: NotificationType) => {
    if (type === NotificationType.ORDER_ASSIGNED || type === NotificationType.SUBSCRIPTION_ASSIGNED) {
  ...
  const getNavigationLink = (notification: Notification) => {
    if (notification.orderId) return `/delivery/orders/${notification.orderId}`;
    return null;
  };
    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Your delivery updates and alerts</p>
          </div>
          {unreadCount > 0 && (
            <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-blue-800">Unread Notifications</p>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-800">Total Notifications</p>
                    ...
                    {notification.metadata && (
                      <div className="flex flex-wrap gap-3 mb-2">
                        ...
                        {notification.metadata.deliveryDate && (
                          <span className="text-xs bg-white px-2 py-1 rounded border border-gray-300">
                            📅 {formatDate(new Date(notification.metadata.deliveryDate))}
                          </span>
                        )}
